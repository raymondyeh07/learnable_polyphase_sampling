...
class TestResNet50DDAC(unittest.TestCase):
  ...
  def test_resnet50_LPS_DDAC(self):
    # ResNet50Custom (LPS) + DDAC
    get_logits = get_logits_model('LPSLogitLayers')
    # Extra model args
    extras_model = {
        'logits_channels': False,
        'conv1_stride': False,
        'maxpool_zpad': False,
  ...
  def test_resnet50_M2N_DDAC(self):
    # ResNet50Custom (Max 2 norm) + DDAC
    # Extra model args
    extras_model = {
        'logits_channels': False,
        'conv1_stride': False,

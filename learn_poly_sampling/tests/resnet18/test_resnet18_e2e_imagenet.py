...
class TestResNet18E2E(unittest.TestCase):
  ...
  def test_resnet18_model_imagenet(self):
    ...
    model = ResNet18Custom(input_shape=(3, 224, 224),
                           num_classes=10,
  ...
  def test_resnet18_LPS_alias_imagenet(self):
  ...
  def test_resnet18_M2N_alias_imagenet(self):

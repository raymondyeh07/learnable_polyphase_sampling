...
class TestResNet101E2E(unittest.TestCase):
  ...
  def test_resnet101_model(self):
    # ResNet101Custom Model
  ...
  def test_resnet101_LPS_alias(self):
    # ResNet101Custom (LPS) + LPF
    get_logits = get_logits_model('LPSLogitLayers')
    # Extra model args
    extras_model = {
        'logits_channels': None,
  ...
  def test_resnet101_M2N_alias(self):
    # ResNet101Custom (Max 2 norm) + LPF
    # Extra model args
    extras_model = {
        'logits_channels': None,
        'conv1_stride': False,
